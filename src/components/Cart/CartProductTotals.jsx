...
const cartProductTotals = (props) => {
    return (
        <React.Fragment>
            <div className="row">
                <div className="col-sm offset-md-6 text-left shop-cart-amounts">
                    Subtotal
                </div>
                <div className="col-sm text-right shop-cart-amounts">
            ...
            <hr/>
            <div className="row">
                <div className="col-sm offset-md-6 text-left">
