                ...
                <div className="col">
                    <div className="row">
                        <div className="col-sm-2">
                            <img className={'shop-cart-image'} src={props.photo} alt={props.photoAlt}/>
                        </div>
                        <div className="col-sm-4">
                            <h5 className="shop-cart-name ">{props.productName}</h5>
                        ...
                        <div className="col-sm-6">
                            <div className="row">
                                <div className="col-sm-6 text-left">
                                    ...
                                    <h6 className={'shop-cart-item total'}>Item Total <span>{props.productTotalPrice}</span></h6>
                                </div>
